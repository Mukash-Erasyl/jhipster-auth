...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '158d3c7d-78b3-4dcc-869c-599a8b298669' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('affa7736-20f9-4b06-9640-ed57b3709d82');
      cy.get(`[data-cy="name"]`).should('have.value', 'affa7736-20f9-4b06-9640-ed57b3709d82');
